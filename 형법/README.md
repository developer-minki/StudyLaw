...
사람의 시기에 대해서 **진통설, 일부노출설, 전부노출설** 등이 대립하고 있으나, **判例는 진통설**의 입장에서 사람의 시기는 규칙적인 진통을 동반하면서 태아가 태반으로부터 이탈하기 시작한 때 다시 말하여 분만이 개시된 때라고 판시하였다.
...
강요나 기망으로 타인을 자살케 한 경우 어떤 범죄가 성립하는지가 문제된다. 판례는 7세, 3세 남짓 된 어린 자식에 대하여 함께 죽을 것을 권유하여 익사하게 한 경우 살인죄의 간접정범을 인정하였다.
...
상해의 개념에 대해서 **신체의 완전성침해설, 생리적 기능훼손설**, 생리적 기능의 훼손과 신체외모의 중대한 변화가 상해라는 **절충설**이 대립하는바, **判例는 생리적 기능훼손설**의 입장에서 난소의 제거로 이미 임신불능 상태에 있는 피해자의 자궁을 적출한 것을 업무상과실치상죄의 상해에 해당한다고 판시하였다.

생각건대, 형법이 상해와 폭행을 엄격히 구별하고 있다는 점을 고려할 때 생리적 기능훼손설이 타당하다.

그러나

상해의 개념에 대해 **判例**는 생리적 기능훼손설의 입장에서 판시하면서도 강간치상죄나 강도치상죄 등에 있어 그 피해자에게 발생한 상해가 **ⓐ극히 경미한 것으로서, ⓑ굳이 치료할 필요가 없어서 자연적으로 치유되며, ⓒ일상생활을 하는데 아무런 지장이 없는 정도**라면 그로 인해 신체의 완전성이 손생되고 생활기능에 장애가 왔다거나 건강상태가 불량하게 변경되었다고 보기는 어려워 강간치상죄 등의 **상해에 해당한다고 할 수 없다**고 판시하였다.

#### 68. 위험한 물건 휴대의 의미

1. 위험한 물건의 의미

   위험한 물건이란 객관적 성질이나 사용방법에 따라 사람의 생명, 신체에 해를 줄 수 있는 물건을 말한다. **判例**는 사회통념에 비추어 그 물건을 사용하면 그 물건을 사용하면 상대방이나 제3자가 곧 살상의 위험을 느낄 수 있으리라고 인정되는 물건인가에 따라 판단하여야 한다고 판시한다.
...
3. '휴대하여'의 의미
   ...
   이에 대해, ①'휴대하여'란 사전적 의미대로 '몸에 지니는 것'을 말한다는 **협의설**, ②소지에 한정하지 않고 널리 이용하는 것도 파악하는 **광의설**이 대립하는바, **判例는 광의설의 입장**에서 위험한 물건을 휴대하여라는 말은 소지뿐만 아니라 널리 이용한다는 뜻도 포함하고 있다고 판시하였다.
...
4. '휴대'에 대한 상대방 인식 요부
   ...
   이에 대해, ①특수폭행죄에 있어서 단체 또는 다중의 위력을 보임과 위험한 물건의 휴대 사이에 균형적인 해석을 위하여 상대방에게 인식시킬 것을 요구하는 **긍정설**과 ②휴대사실은 단지 행위의 수단 때문에 불법이 가중된 것이어서 상대방이 굳이 인식할 필요가 없다는 **부정설**이 대립하는바, **判例는 부정설**의 입장에서 폭력행위 당시 과도를 범행현장에서 호주머니 속에 지니고 있었던 이상 이는 위험한 물건을 휴대한 경우에 해당한다고 판시한다.
...
이에 대해, 형법 제271조 제1항의 법률상·계약상 의무는 예시규정에 불과하고, 본죄의 보호의무는 부진정부작위범의 작위의무와 동일하다고 할 것이므로 관습·조리·사무관리에 의해서도 보호의무가 발생한다는 **예시설**, 법률의 명시적 근거 없이 관습·조리·사무관리 등의 불확정개념을 가벌성의 근거로 도입하는 것은 죄형법정주의에 반하므로 법률 또는 계약에만 보호의무의 근거를 제한하여야 한다는 **제한적 열거설**이 대립하는바, **判例는 제한적 열거설**의 입장에서 법률상 또는 계약상의 의무 있는 자만을 유기죄의 주체로 규정하고 있어 명문상 사회상규의 보호책임을 관념할 수 없다면서 일정거리를 동행한 사실만으로는 피고인에게 법률상 계약상의 보호의무가 있다고 할 수 없다고 판시하였다.
...
1. **甲의 죄책**
   ...
   **가. 구성요건해당성 검토**
   ...
   甲은 허위의 사실을 진실한 것으로 오인하여 허위의 사실을 진실한 것으로 오인하여 공익적인 목적에서 허위의 사실을 기사화하였는바, 이는 비방의 목적과는 상반되는 관계에 있는 공익적인 목적에서 이루어졌다는 판례의 태도를 따를 때, 형법 제309조의 비방할 목적이 부정되므로 해당 죄의 구성요건에는 해당하지 아니한다.
   ...
   **나. 위법성조각사유 검토(형법 제310조)**
   ...
   判例는 성실한 검토의무이론의 입장에서 기사작성의 목적이 공공의 이익에 관한 것이고, 그 기사 내용을 작성자가 진실하다고 믿었으며 그와 같이 믿은 데에 객관적인 상당한 이유가 있으므로 명예훼손의 위법성은 부정된다고 판시하였다.
...
2. **乙의 죄책**
   ...
   **가. 형법 제307조 제2항 (직접)정범 성립여부**
   ...
   이에 대해, ①개별적으로 특정된 한 사람에게 한 말도 그것이 결과적으로 불특정 또는 다수인에게 전파될 가능성이 있으면 공연성을 인정하는 **긍정설**과 ②공연성은 불특정 또는 다수인이 현실로 인식할 것을 요하지는 않지만 적어도 직접 인식할 수 있는 상태에 이르러야 한다는 **부정설**이 대립하는바, **判例는 긍정설**의 입장에서 개별적으로 한 사람에 대하여 사실을 유포하였다고 하더라도 그로부터 불특정 또는 다수인에게 전파될 가능성이 있다면 공연성의 요건을 충족한다고 판시한다. 다만, **判例**는 명예를 훼손하는 사실적시의 상대방이 타인을 위하여 또는 사실적시자를 위하여 이를 비밀로 지켜줄 만한 일정한 친족관계 내지 친분관계가 있거나 이를 직무상 취급하는 관계로 그 적시된 사실의 비밀이 보장될 수 있는 경우에는 전파가능성을 부정하고 있다.
...
이에 대해, ①업무방해죄의 본질은 자유보장이라는 점에서 공무집행방해죄와 본질적으로 동일하다고 보므로 업무방해죄의 업무에 공무가 포함된다는 **긍정설**과 ②업무방해죄는 개인의 경제활동 및 인격활동의 자유를 보호하기 위한 범죄이므로 공무는 포함되지 아니한다는 **부정설**이 대립하는바, **判例는 부정설**의 입장에서 공무원이 직무상 수행하는 공무를 방해하는 행위에 대해서는 업무방해죄로 의율할 수는 없다고 판시하였다.

생각건대, 긍정설에 의할 경우 가벌성을 확장하여 죄형법정주의에 위반되므로 부정설이 타당하다.
...
1. 주거침입죄의 보호법익
   ...
   주거침입죄의 구체적인 보호법익이 무엇인가에 대해 ①**주거권설**과 ②**사실상 평온설**이 대립하고, **判例는 사실상 평온설**의 입장에서 주거침입죄는 사실상의 주거의 평온을 보호법익으로 하는 것이므로 그 거주자 또는 간수자가 건조물 등에 거주 또는 간수할 권리를 가지고 있는지 여부는 범죄의 성립을 좌우하는 것이 아니라고 판시하였다.

   생각건대, 주거에 대한 출입의 승낙이 다른 공동주거자의 의사에 반하는 경우라도 구체적인 상황에 따라 주거침입죄의 성립범위를 제한할 수 있다는 점에서 사실상 평온설이 타당하다.

2. 주거침입죄의 보호의 정도

   주거의 사실상 평온을 보호법익으로 하는 주거침입죄의 보호의 정도에 대하여 ①**침해범설**과 ②**추상적 위험범설**이 대립하고, **判例는 침해범설**의 입장에서 비록 신체의 일부만이 집안으로 들어갔다고 하더라도 사실상 주거의 평온을 해하였다면 주거침입죄는 기수에 이르렀다고 판시한다.

   생각건대, 침해행위가 있음에도 주거의 평온이 침해되지 않는 경우는 없다 할 것이므로 침해범설이 타당하다.

3. 주거침입죄의 기수시기

   주거침입죄의 기수시기와 관련하여 신체의 전부가 아니라 일부만이 주거 안으로 들어간 경우에도 주거침입죄가 성립할 것인지가 문제된다. 이에 대해 ①신체의 일부가 들어가도 사실상 주거의 평온을 교란한 경우에는 주거침입죄의 기수가 성립한다는 **일부침입설**과 ②형법상 주거침입죄의 미수범 규정을 이유로 신체가 전부침입하여야만 기수가 성립한다는 **전부침입설**이 대립하고, **判例는 일부침입설**의 입장에서 주거침입죄의 범의는 반드시 신체의 전부가 타인의 주거 안으로 들어간다는 인식이 있어야만 하는 것이 아니라 신체의 일부라도 타인의 주거 안으로 들어가는 인식이 있으면 족하다고 판시한다.
...
생각건대, 공범 중 1인이 공모의 범위를 초과하여 행위한 때에는 그 부분에 대해서는 단독범이 될 뿐이고, **준강도는 절도의 결과적 가중범이 아니라는 점에서 특수절도죄설이 타당**하다. 다만, 폭**행으로 인한 상해를 예견가능할 경우에는 추가로 과실치상죄가 성립**하고 이는 특수절도죄와는 **경합범 관계**에 있다.
...
③부작위에 의한 기망이 작위에 의한 기망과 그 행위정형이 동가치한 것으로 평가될 수 있을 것
