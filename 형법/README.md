...
이에 대해, ①협박죄는 침해범이므로 해악의 고지로 현실적으로 상대방이 공포심을 느꼈을 때 기수가 된다는 **침해범설**과 ②협박죄는 추상적 위험범이므로 객관적으로 공포심을 일으킬 정도의 해악을 고지하고 상대방이 그것을 인식한 이상, 상대방이 현실적으로 공포심을 일으켰는지와 관계없이 협박죄는 기수가 된다는 **추상적 위험범설**이 대립하는바, **判例는 추상적 위험범설**의 입장에서 협박죄가 성립하려면 고지된 해악의 **내용이 일반적으로 사람으로 하여금 공포심을 일으키게 하기에 충분한 것**이어야 하지만, 상대방이 그에 의하여 현실적으로 공포심을 일으킬 것까지 요구하는 것은 아니며, 그와 같은 정도의 **해악을 고지함으로써 상대방이 그 의미를 인식한 이상 상대방이 현실적으로 공포심을 일으켰는지 여부와 관계없이** 그로써 구성요건은 충족되어 협박죄의 기수에 이르는 것이라고 판시하였다.
...
`(내생각)범죄 두개가 결합된 형태의 범죄는 실행의 착수시기를 후행 범죄를 기준으로 해야 선행 범죄만을 저지른 자와 구분 가능`
...
이에 대해, ①사자의 점유를 부정할 뿐 아니라 피해자의 사망에 의해 재물이 피해자의 지배를 떠나기 때문에 탈취죄는 성립할 수 없다는 **점유이탈물횡령죄설**과 사자의 생전 점유가 그 사망 직후에도 다소 계속되므로 탈취죄가 성립할 수 없다는 **절도죄설**이 대립하는바, **判例는 절도죄설**의 입장에서 피해자를 살해한 방에서 피해자가 소지하는 물건을 영득의 의사로 가지고 나온 경우 살인죄 외에 절도죄 성립을 긍정하였다.

생각건대, 살인행위와 절취행위 사이에 시간적, 장소적 근접성이 인정되는 경우, 피해자의 생존점유의 계속을 인정할 수 있다는 점에서 절도죄설이 타당하다.

#### 85. 절도죄의 기수시기

절도죄(형법 제329조)에서 절취란 점유자의 의사에 반하여 그 점유를 배제하고, 자기 또는 제3자의 새로운 점유를 취득하는 것을 말한다. 따라서 절도죄의 기수가 인정되기 위해서는 점유자의 점유 배제 후 행위자 또는 제3자가 재물에 대하여 방해받지 않는 사실상의 지배를 취득하여야 한다. 구체적으로 **判例**는 ①재물의 크기, 무게에 비추어 운반이 용이한 재물은 손에 집어 드는 순간 기수가 되나 ②쉽게 운반할 수 없는 재물은 적어도 반출할 수 있는 상태에 이르러야 기수가 된다고 판시한다.

#### 90. 채무면탈목적 살인과 강도살인죄 성부

채무면탈의 목적으로 살인한 경우의 죄책에 대해 ①재산상 이익의 취득은 상대방의 의사를 억압한 상태에서 이루어지는 것이므로 외형상 처분행위의 존재와 관계없이 강도살인죄가 성립한다는 **강도살인죄설**과 ②강취행위를 통하여 현실적으로 재산상 이득을 취득하거나 최소한 취득할 개연성이 있는 경우에만 강도살인죄가 성립한다는 **절충설**이 대립하는바, **判例는 절충설**의 입장에서 재산상 이익이 사실상 피해자에 대하여 불이익하게 범인 또는 제3자 앞으로 이전되었다고 볼 만한 상태가 이루어져야 하는데, ⓐ채무의 존재가 명백할 뿐만 아니라, ⓑ채권자의 상속인이 존재하고, ⓒ그 상속인에게 채권의 존재를 확인할 방법이 확보되어 있는 경우에는 비록 그 채무를 면탈할 의사로 채권자를 살해하였더라도 **일시적으로 채권자 측의 추급을 면한 것에 불과하여 강도살인죄가 성립할 수 없다**고 판시한다.
