...
의사지배가 인정되면 형법 제253조의 위계, 위력에 의한 살인죄가, 의사지배가 부정될 경우에는 제252조 제2항의 자살교사, 방조죄가 성립한다.
...
상해의 개념에 대해 **判例는** 생리적 기능훼손설의 입장에서 판시하면서도 강간치상죄나 강도치상죄 등에 있어 그 피해자에게 발생한 상해가 **ⓐ극히 경미한 것으로서, ⓑ굳이 치료할 필요가 없어서 자연적으로 치유되며, ⓒ일상생활을 하는데 아무런 지장이 없는 정도**라면 그로 인해 신체의 완전성이 손생되고 생활기능에 장애가 왔다거나 건강상태가 불량하게 변경되었다고 보기는 어려워 강간치상죄 등의 **상해에 해당한다고 할 수 없다**고 판시하였다.
...
생각건대, 공포심을 느꼈을 것이라는 피해자의 주관적 표상에 따라 협박죄의 기미수를 구분하는 것은 그 기준이 불명확하므로 판례의 태도가 타당하다.
