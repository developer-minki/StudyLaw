...
①**제한적 긍정설**은 고지의무는 증인을 위한 것이므로 원칙적으로 증거능력이 인정되고, 다만 증언거부권의 불고지와 증언 사이 인과관계가 존재하는 경우에 한해 증거능력 부정한다는 견해이고, ②**부정설**은 증언거부권 고지는 절차적 보장으로서 적정절차원리에 비추어 증거능력 부정한다 견해이다.
