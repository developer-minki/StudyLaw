...
2. 가처분의 피보전권리에 따른 관계
   ...
   그러나 판례는 취득시효 완성 당시의 소유명의자의 소유권등기가 무효이고, 가처분권리자가 진정한 소유자이며, 그 가처분의 피보전권리가 진정명의회복을 위한 소유권이전등기청구권이라면, 가처분권리자는 원래 취득시효 완성을 원인으로 한 소유권이전등기청구의 상대방이 되어야 하는 사람이라고 판시한다.

   사안의 경우, 무는 진정명의회복을 원인으로 한 소유권이전등기청구권을 피보전권리로 한 가처분권리자이므로 취득시효완성자인 정에 대해 소유권이전등기를 해주어야 할 의무자이므로 정에게 대항할 수 없다. 따라서 정이 진정한 X임야의 소유자이므로 무와 D 앞으로 순차로 마쳐진 소유권이전등기는 원인무효의 등기이므로 각 이전등기의 말소를 구할 수 있다.
